...
public final class zn0 extends wn.b {
    public zn0(hn hnVar, jn jnVar, jn jnVar2, boolean z) {
    ...
    public zn0(hn hnVar, jn jnVar, jn jnVar2, jn[] jnVarArr, boolean z) {
    ...
    public final wn a(wn wnVar) {
        ...
        return new zn0(hnVar, yn0Var7, yn0Var8, new jn[]{yn0Var9}, this.e);
    }

    @Override // defpackage.wn
    public final wn c() {
        b();
        return new zn0(null, this.b, e(), false);
    }

    @Override // defpackage.wn
    public final wn m() {
        return j() ? this : new zn0(this.a, this.b, this.c.m(), this.d, this.e);
    }
    ...
    public final wn w() {
        ...
        h50.q(yn0Var2.g, iArr5, iArr);
        if (z61.b(yn0Var2.g, iArr5, iArr2) != 0 || (iArr2[4] == -1 && z61.V(iArr2, h50.P))) {
            z61.f(5, 21389, iArr2);
        }
        h50.k(iArr2, iArr, iArr2);
        h50.n(iArr2, z61.i(iArr2, iArr2, iArr2));
        h50.k(iArr3, yn0Var2.g, iArr3);
        h50.n(iArr3, z61.Z0(5, iArr3));
        h50.n(iArr, z61.a1(5, iArr4, iArr));
        yn0 yn0Var4 = new yn0(iArr4);
        h50.o(iArr2, iArr4);
        int[] iArr6 = yn0Var4.g;
        h50.q(iArr6, iArr3, iArr6);
        int[] iArr7 = yn0Var4.g;
        h50.q(iArr7, iArr3, iArr7);
        yn0 yn0Var5 = new yn0(iArr3);
        h50.q(iArr3, yn0Var4.g, iArr3);
        int[] iArr8 = yn0Var5.g;
        h50.k(iArr8, iArr2, iArr8);
        int[] iArr9 = yn0Var5.g;
        h50.q(iArr9, iArr, iArr9);
        yn0 yn0Var6 = new yn0(iArr2);
        if (z61.Y0(5, 0, yn0Var.g, iArr2) != 0 || (iArr2[4] == -1 && z61.V(iArr2, h50.P))) {
            z61.f(5, 21389, iArr2);
        }
        if (!h) {
            int[] iArr10 = yn0Var6.g;
            h50.k(iArr10, yn0Var3.g, iArr10);
        }
        return new zn0(hnVar, yn0Var4, yn0Var5, new jn[]{yn0Var6}, this.e);
    }
