...
public final class ul2 implements i50 {
    public final /* synthetic */ cl2 P;
    public final /* synthetic */ zl2 Q;

    public ul2(zl2 zl2Var, cl2 cl2Var) {
        this.Q = zl2Var;
        this.P = cl2Var;
    }
    ...
    public final void c(n2 n2Var) {
        try {
            ...
            String str = n2Var.b;
            String str2 = n2Var.c;
            sv2.b(canonicalName + "failed to loaded mediation ad: ErrorCode = " + i + ". ErrorMessage = " + str + ". ErrorDomain = " + str2);
            this.P.P2(n2Var.a());
