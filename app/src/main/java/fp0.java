...
public final class fp0 extends wn.a {
    public fp0(hn hnVar, jn jnVar, jn jnVar2, boolean z) {
    ...
    public fp0(hn hnVar, jn jnVar, jn jnVar2, jn[] jnVarArr, boolean z) {
    ...
    public final wn a(wn wnVar) {
        ...
        if (jnVar9.i()) {
            ...
            if (jnVar6.i()) {
                return new fp0(hnVar, jnVar6, hnVar.c.n(), this.e);
            }
            ...
            jn j3 = j.j(j2);
            if (j3.i()) {
                return new fp0(hnVar, j3, hnVar.c.n(), this.e);
            }
            jn j4 = a.j(o);
            if (!h2) {
                j4 = j4.j(i);
        ...
        return new fp0(hnVar, jnVar6, jnVar5, new jn[]{jnVar7}, this.e);
    }

    @Override // defpackage.wn
    public final wn c() {
        b();
        return new fp0(null, this.b, e(), false);
    }
    ...
    public final wn m() {
        ...
        jn jnVar2 = this.c;
        jn jnVar3 = this.d[0];
        return new fp0(this.a, jnVar, jnVar2.a(jnVar3), new jn[]{jnVar3}, this.e);
    }
    ...
    public final wn w() {
        ...
        if (a.i()) {
            return new fp0(hnVar, a, hnVar.c.n(), this.e);
        }
        jn o2 = a.o();
        if (h) {
            j2 = a;
        ...
        return new fp0(hnVar, o2, jnVar.p(a, j).a(o2).a(j2), new jn[]{j2}, this.e);
    }
    ...
    public final wn x(wn wnVar) {
        ...
        if (!jnVar2.i() && i.h()) {
            ...
            if (o4.i()) {
                ...
                return new fp0(hnVar, l, hnVar.c.n(), this.e);
            } else {
                jn j2 = l.o().j(j);
                jn j3 = l.j(o4).j(o3);
                return new fp0(hnVar, j2, l.a(o4).o().l(a, b, j3), new jn[]{j3}, this.e);
            }
        }
        return w().a(wnVar);
    }
