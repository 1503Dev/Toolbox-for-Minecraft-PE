...
public final class p81 extends KeyFactorySpi implements n7 {
    @Override // defpackage.n7
    public final PublicKey a(nu0 nu0Var) {
        return new m8(nu0Var);
    }

    @Override // defpackage.n7
    public final PrivateKey b(bg0 bg0Var) {
        return new l8(bg0Var);
    }
    ...
    public final PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                return new l8(bg0.p(t.s(((PKCS8EncodedKeySpec) keySpec).getEncoded())));
            } catch (Exception e) {
    ...
    public final PublicKey engineGeneratePublic(KeySpec keySpec) {
        if (keySpec instanceof X509EncodedKeySpec) {
            try {
                return new m8(nu0.p(((X509EncodedKeySpec) keySpec).getEncoded()));
            } catch (Exception e) {
                throw new InvalidKeySpecException(e.toString());
            }
        }
    ...
    public final Key engineTranslateKey(Key key) {
        if ((key instanceof l8) || (key instanceof m8)) {
            return key;
        }
