...
public final class y10 extends lc implements wb0.a {
    ...
    */
    public y10(View view, hj hjVar) {
        super(hjVar, view, 1, (Switch) r0[2]);
    ...
    public final void I() {
        ...
        boolean z = false;
        if (j2 != 0) {
            if ((j & 6) != 0 && y21Var != null) {
                str = y21Var.a.e(this.T.getContext());
            } else {
                str = null;
            }
            if (y21Var != null) {
        ...
        if (j2 != 0) {
            we.a((Switch) this.e0, z);
        }
        if ((j & 4) != 0) {
            we.b((Switch) this.e0, this.h0, null);
        }
    }
