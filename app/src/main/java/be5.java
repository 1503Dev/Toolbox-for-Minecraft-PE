...
public final class be5 extends wc5 implements RandomAccess, uf5 {
    public float[] Q;
    public int R;

    static {
        new be5(new float[0], 0, false);
    }
    ...
    public be5(float[] fArr, int i, boolean z) {
        super(z);
        this.Q = fArr;
        this.R = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (collection instanceof be5) {
            be5 be5Var = (be5) collection;
            int i = be5Var.R;
            if (i == 0) {
                return false;
            }
            ...
            if (Integer.MAX_VALUE - i2 >= i) {
                ...
                System.arraycopy(be5Var.Q, 0, this.Q, this.R, be5Var.R);
                this.R = i3;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public final /* bridge */ /* synthetic */ qe5 e(int i) {
        if (i >= this.R) {
            return new be5(Arrays.copyOf(this.Q, i), this.R, true);
        }
