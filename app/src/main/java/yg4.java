...
public final class yg4 implements lj5 {
    public final uj5 a;
    public final uj5 b;
    public final uj5 c;

    public yg4(mj5 mj5Var, uj5 uj5Var, uj5 uj5Var2) {
        this.a = mj5Var;
        this.b = uj5Var;
        this.c = uj5Var2;
    }
    ...
    public final vg4 c() {
        ...
        if (((Integer) w82Var.c.a(x92.p5)).intValue() > 0) {
            if (!((Boolean) w82Var.c.a(x92.m5)).booleanValue() || z) {
                hk4 a = ik4Var.a(ak4.Rewarded, context, tj4Var, new jz1(5, new wf4()));
